...
{
    /// <inheritdoc />
    public partial class AddingCategoriesAndCharacteristicsForProducts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCharacteristicValue", x => new { x.CharacteristicValueId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductCharacteristicValue_CharacteristicValues_Characteris~",
                        column: x => x.CharacteristicValueId,
                        principalTable: "CharacteristicValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductCharacteristicValue_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "ProductCharacteristicValue",
                column: "ProductId");
        }
